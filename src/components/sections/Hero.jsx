    ...
    <div className="w-full bg-gradient-to-r from-[#05071E] via-[#05071E] to-[#111A89] relative overflow-hidden pt-[100px] sm:pt-[120px]">
      ...
      <div className="max-w-[1440px] mx-auto px-4 lg:px-[100px] relative z-10">
        ...
        <div className="w-full max-w-[1041px] mx-auto flex flex-col items-start sm:items-center justify-center gap-[25px] min-h-[532px] text-left sm:text-center">
          {/* Welcome tag */}
          <motion.div
            className="inline-flex items-center justify-start sm:justify-center bg-[#2E6D9C] backdrop-blur-sm border border-white/50 rounded-full py-2 px-4 gap-2"
            variants={fadeUp}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
          ...
          {/* Hero text content */}
          <motion.div
            className="w-full flex flex-col items-start sm:items-center gap-4 sm:gap-6"
            variants={fadeUp}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
          ...
          {/* CTAs */}
          <motion.div
            className="flex flex-col sm:flex-row justify-start sm:justify-center items-start sm:items-center gap-4 sm:gap-[46px] w-full sm:max-w-[483px] mt-6 sm:mt-[75px]"
            variants={fadeUp}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
      ...
      <motion.div
        className="relative w-full pt-[60px] sm:pt-[100px] flex justify-center items-center overflow-hidden"
